...
public class DynamicInputConfigurationManager {
    ...
    /**
     * Responsible for initializing members. Members may be initialized to a previous state
     * depending on whether a configuration filename is provided (previously constructed
     * configuration file must exist, in this case).
     *
     * @param configFilename  Name of a file for a previously persisted configuration
     * @throws SAXException
     * @throws IOException
