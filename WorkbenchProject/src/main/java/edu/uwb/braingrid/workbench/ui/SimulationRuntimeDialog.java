...
/**
 * Panel for displaying simulation runtime status output to user and the activation of analysis on
 * simulation output by user. This class is substantiated by the SimStartWiz object after the
...
public class SimulationRuntimeDialog extends javafx.scene.control.Dialog {
    ...
    /**
     * Analyze action event checks script output to determine if simulation is complete and updates
     * outputTextArea accordingly.
     */
