 ...
 * by this class. All functions require that the manager of an existing record of workbench
 * related provenance be specified in order to decouple this class from the maintenance and
...
public final class WorkbenchOperationRecorder {
     ...
     * @param sourceEntityURI  A unique identifier for the original entity that was uploaded
     *                         (the machine location is inferred to be whatever the local name
     *                         space is set to)
     ...
     */
    public static Resource uploadFile(ProvMgr provMgr, String sourceEntityURI, String destinationEntityURI,
            String entityLabel, String remoteLocation, String activityURI, Date timeUploadStarted,
        ...
        Resource destinationEntity = provMgr.addEntity(destinationEntityURI, entityLabel, remoteLocation, null, false);
        // add workbench as an agent
        Resource workbenchAgent = provMgr.addSoftwareAgent(WORKBENCH_SOFTWARE_AGENT_URI, null, false, false);
    ...
    /**
     * Creates a provenance record for a file copy operation which was executed by a
     * software agent.
     *
     * @param provMgr  The manager for the provenance
     ...
     * @param destinationEntityURI  A unique identifier for the entity that was generated by
     *                              the upload operation
     * @param activityURI  An identifier for the activity of copying the entity one location
     ...
     */
    public static Resource copyFile(ProvMgr provMgr, String sourceEntityURI, String destinationEntityURI,
            String entityLabel, String activityURI, Date timeCopyStarted, Date timeCopyEnded) {
        ...
        Resource destinationEntity = provMgr.addEntity(destinationEntityURI, entityLabel, null, null, false);
        // add workbench as an agent
        Resource workbenchAgent = provMgr.addSoftwareAgent(WORKBENCH_SOFTWARE_AGENT_URI, null, false, false);
