...
public class ProvenanceStatement {
    ...
    /**
     * Constructs this provenance statement based on a statement from a RDF model.
     *
    ...
    /**
     * Constructs this provenance statement based on a subject, predicate, and object.
     *
    ...
    /**
     * Provides the statement used to create this provenance statement. May be null.
     *
     ...
     * @param literal  If true, a Literal will be constructed, otherwise, a Resource
     */
    ...
    /**
     * Provides a collection of provenance statements from the specified model which exactly match
     * the URIs of the subject, predicate, and object of this provenance statement. This function
     * is more efficient than relaxedQuery since it allows indexes maintained by the implementation
     * to improve performance. However, differences between name space prefixes (which may occur
     * automatically when statements are loaded from disk) will cause many seemingly matching
     * statements to be ignored. The subject, and/or predicate, and/or object of this provenance
     * statement will be used as wildcards if null.
     *
     * @param model  The model to match statements against this
     * @param unique  Determines whether the collection should only contain unique provenance
     *                statements
